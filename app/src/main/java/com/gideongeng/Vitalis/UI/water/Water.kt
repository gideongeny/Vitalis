...
package com.gideongeng.Vitalis.UI.water
...
import com.gideongeng.Vitalis.Adapter.WAdapter
import com.gideongeng.Vitalis.R
import com.gideongeng.Vitalis.data_Model.water
import com.gideongeng.Vitalis.databinding.ActivityWaterBinding
...
class Water : AppCompatActivity() {
    ...
    private var userDitails: DocumentReference =  FirebaseFirestore.getInstance().collection("user").document(FirebaseAuth.getInstance().currentUser!!.uid.toString().toString())
    @RequiresApi(Build.VERSION_CODES.O)
